...
namespace Elepla.Service.Mappers
{
	public class MapperConfigurationsProfile : Profile
	{
		public MapperConfigurationsProfile()
		{
			...
			CreateMap<Planbook, ViewListPlanbookTemplateDTO>()
				.ForMember(dest => dest.PlanbookId, opt => opt.MapFrom(src => src.PlanbookId))
                .ForMember(dest => dest.Title, opt => opt.MapFrom(src => src.Title))
                .ForMember(dest => dest.Subject, opt => opt.MapFrom(src => src.Lesson.Chapter.SubjectInCurriculum.Subject.Name))
                .ForMember(dest => dest.Grade, opt => opt.MapFrom(src => src.Lesson.Chapter.SubjectInCurriculum.Grade.Name))
                .ForMember(dest => dest.Curriculum, opt => opt.MapFrom(src => src.Lesson.Chapter.SubjectInCurriculum.Curriculum.Name))
                .ForMember(dest => dest.Chapter, opt => opt.MapFrom(src => src.Lesson.Chapter.Name))
			...
			CreateMap<Chapter, ViewListChapterDTO>()
				...
				.ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.Name))
                .ForMember(dest => dest.SubjectInCurriculumId, opt => opt.MapFrom(src => src.SubjectInCurriculumId))
                .ForMember(dest => dest.SubjectId, opt => opt.MapFrom(src => src.SubjectInCurriculum.Subject.SubjectId))
                .ForMember(dest => dest.Subject, opt => opt.MapFrom(src => src.SubjectInCurriculum.Subject.Name))
                .ForMember(dest => dest.CurriculumId, opt => opt.MapFrom(src => src.SubjectInCurriculum.Curriculum.CurriculumId))
                .ForMember(dest => dest.Curriculum, opt => opt.MapFrom(src => src.SubjectInCurriculum.Curriculum.Name))
                .ForMember(dest => dest.GradeId, opt => opt.MapFrom(src => src.SubjectInCurriculum.Grade.GradeId))
                .ForMember(dest => dest.Grade, opt => opt.MapFrom(src => src.SubjectInCurriculum.Grade.Name))
			...
			CreateMap<Lesson, ViewListLessonDTO>()
                ...
                .ForMember(dest => dest.Subject, opt => opt.MapFrom(src => src.Chapter.SubjectInCurriculum.Subject.Name))
                .ForMember(dest => dest.CurriculumId, opt => opt.MapFrom(src => src.Chapter.SubjectInCurriculum.Curriculum.CurriculumId))
                .ForMember(dest => dest.Curriculum, opt => opt.MapFrom(src => src.Chapter.SubjectInCurriculum.Curriculum.Name))
                .ForMember(dest => dest.GradeId, opt => opt.MapFrom(src => src.Chapter.SubjectInCurriculum.Grade.GradeId))
                .ForMember(dest => dest.Grade, opt => opt.MapFrom(src => src.Chapter.SubjectInCurriculum.Grade.Name))
                .ForMember(dest => dest.CreatedAt, opt => opt.MapFrom(src => src.CreatedAt))
				.ForMember(dest => dest.CreatedBy, opt => opt.MapFrom(src => src.CreatedBy))
				.ForMember(dest => dest.UpdatedAt, opt => opt.MapFrom(src => src.UpdatedAt))
				.ForMember(dest => dest.UpdatedBy, opt => opt.MapFrom(src => src.UpdatedBy))
			...
			CreateMap<UserPackage, ViewListUserPackageDTO>()
                ...
                .ForMember(dest => dest.PaymentUrl, opt => opt.MapFrom(src => src.Payments.FirstOrDefault().PaymentUrl))
                .ForMember(dest => dest.CreatedAt, opt => opt.MapFrom(src => src.CreatedAt))
				.ForMember(dest => dest.CreatedBy, opt => opt.MapFrom(src => src.CreatedBy))
				.ForMember(dest => dest.UpdatedAt, opt => opt.MapFrom(src => src.UpdatedAt))
				.ForMember(dest => dest.UpdatedBy, opt => opt.MapFrom(src => src.UpdatedBy))
