...
namespace Elepla.Repository.Repositories
{
    public class AccountRepository : GenericRepository<User> , IAccountRepository
    {
        ...
        {
            return await _dbContext.Users.FirstOrDefaultAsync(u => u.Email == emailOrUsernameOrPhoneNumber || u.Username == emailOrUsernameOrPhoneNumber || u.PhoneNumber == emailOrUsernameOrPhoneNumber);
        }
    }
}
